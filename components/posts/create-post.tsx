import { Camera, Image, Paperclip, PictureInPicture, Video } from "lucide-react";
      ...
      <CardContent>
        <div className="relative">
          ...
          <Textarea
            ...
            className={"peer pl-14 h-25 resize-none rounded-xl placeholder:text-muted-foreground placeholder:font-medium"}
          />
        </div>
      </CardContent>
      <CardFooter>
